...
readerDirectory = [test_video_directory VideoFileName];
writerDirectory = [VideoWriterDirectory VideoWriterFileName];
readerobj = VideoReader(readerDirectory);
videoWriterObj = VideoWriter(writerDirectory);
space = 'rgb';
thresh = 0.67;
open(videoWriterObj);
